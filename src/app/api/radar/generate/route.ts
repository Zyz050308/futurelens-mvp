...
7. 必须先识别用户主问题里的中心产出对象，例如模板、方案、表格、文案、脚本、SOP、流程、计划、材料、清单、报告、说明、作品、视频等。
8. 如果主问题里有明确产出对象，solutionResult 必须围绕这个产出对象生成；补充字段里的“学习能力 / 想知道怎么做 / 工作流 / 效率”等词只能作为辅助需求，不能覆盖主问题。
9. Skill 匹配规则：
   - 明确要做表格、流程、SOP、汇报、整理、复盘、项目管理等可复用操作流 => 工作流生成 Skill
   - 明确要做文案、说明、申请、商业计划书、BP、介绍、讲稿、邮件、材料、模板等可交付内容 => 材料生成 Skill
   - 明确要学习、备考、训练技能、复习、练习、课程推进，且主问题没有更明确的产出对象 => 学习路径 Skill
   - 都不匹配 => 通用解决 Skill
